...
import contactData from '../../edit_content/pages/contact.json';
        ...
        <div>
          ...
          <div className="mt-9">
            ...
            <div className="mt-6 flex">
              ...
              <div className="ml-3 text-base text-tn-gray">
                {((contactInfo as any)?.email?.value || 'Bsmith@tnpghomes.com | Tsmith@tnpghomes.com').split(' | ').map((email: string, idx: number) => (
                  <p key={idx}>{email}</p>
                ))}
              </div>
            </div>
