...
import logo from '../../../media/LogoFull.webp';
import partnerLogo1 from '../../../media/PartnerLogo_1.webp';
import partnerLogo2 from '../../../media/PartnerLogo_2.webp';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-24 lg:gap-32">
                    ...
                    <div className="mt-12 lg:mt-0 lg:col-span-2">
                        <div className="flex w-full flex-row items-start justify-center gap-8 lg:gap-12">
                            ...
                            { (resourcesData && (resourcesData as any).enabled) && (
                            <div className="text-left">
