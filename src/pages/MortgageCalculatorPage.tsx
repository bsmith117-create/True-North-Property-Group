...
const MortgageCalculatorPage: React.FC = () => {
  ...
  // Derived value (computed during render, no state sync needed)
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center p-8 bg-tn-teal text-white rounded-lg shadow-lg">
                        ...
                        <div className="space-y-2 text-left mt-6 pt-6 border-t border-white/30">
                           ...
                           <div className="flex justify-between"><span className="font-semibold">Loan Amount:</span> <span>{formatCurrency((homePrice || 0) - (downPayment || 0))}</span></div>
                        </div>
